...
@synthesize photo_small = _photo_small;
@synthesize photo_big = _photo_big;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.photo_small = metaObject->getObject(0x139af8d6);
    object.photo_big = metaObject->getObject(0x764b3bbc);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x139af8d6, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeObject;
        value.nativeObject = self.photo_big;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x764b3bbc, value));
    }
}
